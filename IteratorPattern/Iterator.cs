...
namespace IteratorPattern
{
  ...
  // Iteration works though duck typing - you need a GetEnumerator() that yields a type that
  // has a property called Current and boolean return method called MoveNext()
  public class Node<T>
  {
    public T Value;
